...
1.  Generate a Google Service Account JSON Key for your Google Cloud Project.
    ...
    add a file called `cdp-boston-c384047b.json` to it
    (i.e. `.keys/cdp-boston-c384047b)`. This file will be used later on.
...
1.  Attach the Pulumi Access Token and the
    ...
    1. Pulumi Access Token -- Create a [new secret](https://github.com/CouncilDataProject/boston/settings/secrets/actions/new)

    -   Set the name to: **PULUMI_ACCESS_TOKEN**
    -   Set the value to: The token you kept from step #2
    -   Click "Add secret"

    2. Google Service Account JSON -- Create a [new secret](https://github.com/CouncilDataProject/boston/settings/secrets/actions/new)
...
1.  Once the
    ["Infrastructure" GitHub Action Successfully Completes](https://github.com/CouncilDataProject/boston/actions?query=workflow%3A%22Infrastructure%22)
...
1.  Once the
    ...
    [Direct Link to Enable](https://console.cloud.google.com/apis/api/speech.googleapis.com/data_logging?project=cdp-boston-c384047b)
...
1.  Once the
    ...
    -   Navigate to [Firebase Console](https://console.firebase.google.com),
        login to the Google Account you used during step #2, select the `cdp-boston-c384047b` Firebase project
